...
{
    class PhotoSharingInitializer : DropCreateDatabaseIfModelChanges<PhotoSharingContext>
    {
        ...
        protected override void Seed(PhotoSharingContext context)
        {
            ...
            var photos = new List<Photo>
            {
                new Photo {
                    ...
                    PhotoFile = getFileBytes("\\Photos\\flower.jpg"),
                ...
                new Photo {
                    ...
                    PhotoFile = getFileBytes("\\Photos\\orchard.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "AllisonBrown",
                    PhotoFile = getFileBytes("\\Photos\\path.jpg"),
                    ImageMimeType = "image/jpeg",
                    CreatedDate = DateTime.Today.AddDays(-14)
                },
                new Photo {
                    ...
                    UserName = "JimCorbin",
                    PhotoFile = getFileBytes("\\Photos\\fungi.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "JamieStark",
                    PhotoFile = getFileBytes("\\Photos\\pinkflower.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "JamieStark",
                    PhotoFile = getFileBytes("\\Photos\\blackberries.jpg"),
                    ImageMimeType = "image/jpeg",
                    CreatedDate = DateTime.Today.AddDays(-11)
                },
                new Photo {
                    ...
                    PhotoFile = getFileBytes("\\Photos\\coastalview.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    PhotoFile = getFileBytes("\\Photos\\headland.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "FengHanYing",
                    PhotoFile = getFileBytes("\\Photos\\pebbles.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    PhotoFile = getFileBytes("\\Photos\\pontoon.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "JamieStark",
                    PhotoFile = getFileBytes("\\Photos\\ripples.jpg"),
                    ImageMimeType = "image/jpeg",
                    CreatedDate = DateTime.Today.AddDays(-5)
                },
                new Photo {
                    ...
                    UserName = "JimCorbin",
                    PhotoFile = getFileBytes("\\Photos\\rockpool.jpg"),
                    ImageMimeType = "image/jpeg",
                ...
                new Photo {
                    ...
                    UserName = "AllisonBrown",
                    PhotoFile = getFileBytes("\\Photos\\track.jpg"),
                    ImageMimeType = "image/jpeg",
